            ...
            <div className="space-y-4">
              <div className="border rounded-lg p-4">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="font-bold">${event.standardTicket.price}</span>
                </div>
                ...
                <button
                  ...
                  className={`w-full py-2 rounded-md ${event.standardTicket.sold >= event.standardTicket.quantity 
              ...
              <div className="border rounded-lg p-4">
                ...
                <button
                  ...
                  className={`w-full py-2 rounded-md ${event.vipTicket.sold >= event.vipTicket.quantity 
                    ? 'bg-gray-300 cursor-not-allowed' 
                    : 'bg-blue-600 hover:bg-blue-700 text-white'}`}
                >
