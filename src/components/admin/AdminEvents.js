...
const AdminEvents = () => {
    ...
    useEffect(() => {
        fetchAdminEvents();
    }, [fetchAdminEvents]); // Added fetchAdminEvents to the dependency array
                            ...
                            <tr key={event._id}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                    {event.ticketTypes.map((ticket) => (
                                        <div key={ticket.name} className="text-sm text-gray-900">
                ...
                {events.map((event) => (
                    ...
                    >
                        ...
                        <div className="mt-4 grid grid-cols-2 gap-4 text-sm text-gray-700">
                            ...
                            {/* Dynamically render ticket info for mobile cards */}
